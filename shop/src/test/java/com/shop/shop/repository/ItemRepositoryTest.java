...
class ItemRepositoryTest {
    ...
    public void findByItemNmOrItemDetailTest() {
        this.createItemList();
        List<Item> itemList =
                itemRepository.findByItemNmOrItemDetail("테스트 상품1", "테스트 상폼 상세 설명5");
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    public void findByPriceLessThan() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByPriceLessThan(10005);  //10005보다 작은값 출력
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
    ...
    public void queryDslTest() {
        ...
        List<Item> itemList = query.fetch();   /* query.fetch() 쿼리결과를 리스트로 반환한다 */
        for (Item item : itemList) {
            System.out.println(item.toString());
        }
    }
