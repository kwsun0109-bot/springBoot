package com.example.jpastudy2;


import com.example.jpastudy2.entity.*;
import com.example.jpastudy2.repository.*;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        bookRepository.save(new Book("스프링 부트 핵심 가이드", "장정우", 28000, 30, it));
